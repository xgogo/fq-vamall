...
<html>
    <head>
        ...
        <link href="/mineop/1/wstmall/Apps/Admin/View/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="/mineop/1/wstmall/Apps/Admin/View/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        ...
        <script src="/mineop/1/wstmall/Apps/Admin/View/js/jquery-ui.min.js" type="text/javascript"></script>
        <!-- AdminLTE App -->
        <script src="/mineop/1/wstmall/Apps/Admin/View/js/AdminLTE/app.js" type="text/javascript"></script>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="/mineop/1/wstmall/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.roleName');?>" />
                                    <p>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="/mineop/1/wstmall/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.staffName');?>" />
                        </div>
                    ...
                    <ul class="sidebar-menu">
                    	<?php if(in_array('yfq_00',$WST_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="#">
                                <span>易分钱</span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if(in_array('yfq_01',$WST_STAFF['grant'])){ ?>
                                	<li><a href="<?php echo U('Admin/Yfq/index');?>" target='pageContent'>分期利率配置</a></li>
                                <?php } ?>
                                <?php if(in_array('yfq_02',$WST_STAFF['grant'])){ ?>
					           		<li><a href="<?php echo U('Admin/Yfq/index_user');?>" target='pageContent'>角色配置</a></li>
					            <?php } ?>
                                <?php if(in_array('yfq_03',$WST_STAFF['grant'])){ ?>
					            	<li><a href="<?php echo U('Admin/Yfq/index_users_verify');?>" target='pageContent'>审核认证</a></li>
					            <?php } ?>
