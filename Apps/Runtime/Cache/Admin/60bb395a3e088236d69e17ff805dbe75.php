...
<html lang="zh-cn">
   <head>
      ...
      <link rel="stylesheet" href="/mineop/1/wstmall/Apps/Admin/View/css/AdminLTE.css">
      <!--[if lt IE 9]>
	        ...
	        <div class="col-md-6">
	           <div class="box-header">
	             ...
	             <table class="table table-hover table-striped table-bordered wst-form">
	                ...
	                <tr>
	                   <td width="130">授权类型：</td>
	                   <td><div id='licenseStatus'></div></td>
	                </tr>
	                <tr>
	                   <td width="130">官网地址：</td>
	                   <td id='webUrl'><a href="<?php echo C('WST_WEB');?>" target='_blank'><?php echo C('WST_WEB');?></a></td>
	                </tr>
	                <tr>
	                   <td width="130">问题反馈：</td>
