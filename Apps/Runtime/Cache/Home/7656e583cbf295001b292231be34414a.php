...
<html lang="zh-cn">
	<head>
     	...
     	<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/cartpaylist.css" />
                ...
                <div id="succeed">
                    <div class="success2">
                        ...
                        <div class="wst-cart-step">
                            <img src="/mineop/1/wstmall/Apps/Home/View/default/images/step1.png" /><br />
            ...
            <div class="wst-cart-container">
                ...
                <div class="wst-cartlist-box">
                    <div class="wst-cartlist-head">
                        ...
                        <div class="wst-head-title5">首付</div>
                        <div class="wst-head-title6">分期</div>
                        <!--  
                        <div class="wst-head-title5">库存状态</div>
                      
                        <div class="wst-head-title6">数量</div>
                        -->
                        <div class="wst-head-title7">每期</div>
                ...
                <div class="wst-cartlist-box">
                    ...
                    <div id="catgoodsList">
                        <?php if(is_array($shopgoods['shopgoods'])): $key2 = 0; $__LIST__ = $shopgoods['shopgoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key2 % 2 );++$key2;?><input type="hidden" value="<?php if($goods['goodsStock'] < $goods['cnt']): ?>-1<?php endif; ?>" class="goodsStockFlag"/>
							<div class="wst-cartlist-item" id="selgoods_<?php echo ($goods['goodsId']); ?>" class="selgoods" <?php if($goods['goodsStock'] < $goods['cnt']): ?>style="border:2px solid red;"<?php endif; ?>>
		                        <div class="wst-cartlist-vb">
		                            <input type="checkbox" id="chk_goods_<?php echo ($goods['goodsId']); ?>" name="chk_goods_<?php echo ($goods['shopId']); ?>" value="<?php echo ($goods['goodsId']); ?>" parent="<?php echo ($goods['shopId']); ?>" isBook="<?php echo ($goods['isBook']); ?>" <?php if($goods['ischk'] == 1): ?>checked<?php endif; ?>/>
									<input type="hidden" class="cgoodsId" value="<?php echo ($goods['goodsId']); ?>" />
		                            <input type="hidden" id="price_<?php echo ($goods['goodsId']); ?>" value="<?php echo ($goods['shopPrice']); ?>" />
		                        </div>
		                            ...
		                            <div>
		                                <div class="wst-cartlist-bximg">
		                                 	...
		                                 	<a target="_blank" href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$goods['goodsId']));?>" target="_blank">
		                                        <img src="/mineop/1/wstmall/<?php echo ($goods['goodsThums']); ?>" width="60" height="60" />
		                                    </a>
		                        ...
		                        <div class="wst-cartlist-item-col4" id="">	
		                        <?php echo ($goods["f_pay"]); ?>元
		                        </div>
		                        <!--  
		                        ...
		                        -->
		                        <div class="wst-cartlist-item-col5">共<?php echo ($goods["fenqi"]); ?>期</div>
		                        <!-- 
		                        <div class="wst-cartlist-item-col5">
		                            <div class="wrap-input" style="">
		                                <button id="numl_<?php echo ($goods['goodsId']); ?>" class="wst-cartlist-plus" onclick="changeCatGoodsnum(1,<?php echo ($goods['shopId']); ?>,<?php echo ($goods['goodsId']); ?>,<?php echo ($goods['isBook']); ?>)">-</button>
		                                <input id="buy-num_<?php echo ($goods['goodsId']); ?>" dataId="<?php echo ($goods['goodsAttrId']); ?>" class="text" style="width: 30px; text-align: center;" maxlength="3" value="<?php echo ($goods['cnt']); ?>" onkeypress="return WST.isNumberKey(event);" onkeyup="changeCatGoodsnum(0,<?php echo ($goods['shopId']); ?>,<?php echo ($goods['goodsId']); ?>,<?php echo ($goods['isBook']); ?>);" />
		                                <button id="numr_<?php echo ($goods['goodsId']); ?>" class="wst-cartlist-add" onclick="changeCatGoodsnum(2,<?php echo ($goods['shopId']); ?>,<?php echo ($goods['goodsId']); ?>,<?php echo ($goods['isBook']); ?>)">+</button>
		                            </div>
		                        </div>
		                        
		                        <div class="wst-cartlist-item-col7">¥<span id="prc_<?php echo ($goods['goodsId']); ?>"><?php echo ($goods["shopPrice"] * $goods["cnt"]); ?></span>元</div>
		                         -->
		                           <div class="wst-cartlist-item-col7">¥<span id=""><?php echo ($goods["mq"]); ?></span>元</div>
		                        <div class="wst-cartlist-item-col8""><a href="javascript:delCatGoods(<?php echo ($goods['shopId']); ?>,<?php echo ($goods['goodsId']); ?>);">删除</a></div>
		                        <div class="wst-clear"></div>
...
<div class="wst-footer-hp-box">
	...
	<script src="/mineop/1/wstmall/Apps/Home/View/default/js/cartpaylist.js"></script>
