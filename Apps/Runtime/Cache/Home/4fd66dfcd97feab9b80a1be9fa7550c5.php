...
<html>
	<head>
     	...
     	<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/checkorderinfo.css" />
                ...
                <div id="succeed">
                    <div class="success2" style="">
                        ...
                        <div class="wst-chkod-step">
                            <img src="/mineop/1/wstmall/Apps/Home/View/default/images/step2.png" alt="" /><br />
                    ...
                    <div>                        
						<div id="consignee1">
							<div>
								...
								<span class="wst-chkod-s1-upd"><a href="javascript:toEditAddress();">[修改]</a></span>
							</div>
                            ...
                            <div>
                            	...
                            	<div id="flagdiv" style="display: none;"></div>
                               	<?php if(is_array($addressList)): $key = 0; $__LIST__ = $addressList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$address): $mod = ($key % 2 );++$key;?><div id="caddress_<?php echo ($address['addressId']); ?>">												
									<label>
										<input id="seladdress_<?php echo ($address['addressId']); ?>" onclick="changeAddress();" name="seladdress" type="radio" <?php if($key == 1): ?>checked="checked"<?php endif; ?> value="<?php echo ($address['addressId']); ?>"/>
									...
									<span class="optionspan wst-opt-upd">[<a onclick="javascript:changeAddress();">修改</a>]</span>
									<span class="optionspan wst-opt-del">[<a onclick="javascript:delAddress(<?php echo ($address['addressId']); ?>);">删除</a>]</span>									
								</div><?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
								<div>					
									<label>
										<input id="seladdress_0" name="seladdress" type="radio" value="0" onclick="changeAddress();" <?php if(count($addressList) == 0): ?>checked="checked"<?php endif; ?>/>使用新地址
									</label>
								</div>
                            </div>
                            <div id="address_form" style="">
                                <input type='hidden' id='consignee_add_cityId' name='consignee_add_cityId' value='<?php echo ($areaId2); ?>'/>
                                ...
                                <div class="wst-chkod-line35">
                                    <div class="wst-chkod-cg-yb">邮编：</div>
                                    <div style="float: left; width: 700px;">
                        ...
                        <div id="newaddress">
                            ...
                            <?php if(count($payments['onlines']) > 0): ?><div>
                                ...
                                <div style="width:800px;float:left;">
                                	...
                                	<?php if(is_array($payments['onlines'])): $key = 0; $__LIST__ = $payments['onlines'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($key % 2 );++$key; if($payment['isOnline'] == 1): ?><div style="float:left;width:165px;"><img src="/mineop/1/wstmall/<?php echo ($payment['payIcon']); ?>" width="120" height="45"/></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                	<div style="clear:both;"></div>
                                </div>
                                <div style="clear:both;"></div>
                            </div><?php endif; ?>
                    ...
                    <div class="wst-chkod-dp-box">
                        ...
                        <?php if(is_array($catgoods)): $key = 0; $__LIST__ = $catgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shopgoods): $mod = ($key % 2 );++$key;?><div>
                            ...
                            <?php if($shopgoods["shopgoods"][0]["deliveryStartMoney"] > $shopgoods["totalMoney"]): ?><div id="showwarnmsg_<?php echo ($key); ?>" class="wst-chkod-dp-pb2">
			                		抱歉，您的订单金额未达到该门店的配送订单起步价¥<?php echo ($shopgoods["shopgoods"][0]["deliveryStartMoney"]); ?>元，不能提交订单。
			                	</div>
                        ...
                        <div>
                            <div class="wst-chkod-glist-tb">
                                ...
                                <div class="wst-chkod-glist-tt3">首付</div>
                                <div class="wst-chkod-glist-tt4">分期</div>
                            ...
                            <?php if(is_array($shopgoods['shopgoods'])): $key2 = 0; $__LIST__ = $shopgoods['shopgoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key2 % 2 );++$key2;?><div class="selgoods" class="wst-chkod-dp-pb3">
                                        ...
                                        <div>
                                            <div class="wst-cart-goods-img">
                                                <a href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$goods['goodsId']));?>" target="_blank">
                                                    <img src="/mineop/1/wstmall/<?php echo ($goods['goodsThums']); ?>" width="60" height="60" /></a>
                                            </div>
                                    ...
                                    <div class="wst-chkod-od-crt2"><?php echo ($goods['f_pay']); ?></div>
                                    <div class="wst-chkod-od-crt3">每期:￥<?php echo ($goods["mq"]); ?>元&nbsp;*&nbsp;<?php echo ($goods["fenqi"]); ?>期</div>
...
<div class="wst-footer-hp-box">
	...
	function subCheckArea(){
	    ...
	    <?php if(is_array($shopColleges)): $key = 0; $__LIST__ = $shopColleges;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shopCollege): $mod = ($key % 2 );++$key;?>var shopCollege = ',<?php echo ($shopCollege); ?>,';
			...
			if(idx==-1){
				$("#areaOk").val("0");	
				alert("门店“"+$("#sp_<?php echo ($key-1); ?>").html()+"”中的商品不在配送区域内！");
				return false;
			}else{
				$("#areaOk").val("1");
	...
	function changeRequestdate(){
		...
		var currMinutes = d.getMinutes();
	   	...
	   	var startNum = <?php echo ($startTime); ?>;
