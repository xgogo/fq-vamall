...
<html lang="zh-cn">
	<head>
     	...
     	<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/goodslist.css" />
				...
				<div class="wst-goods-page">
					<?php if(is_array($pages['root'])): $key = 0; $__LIST__ = $pages['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key % 2 );++$key;?><li class="wst-goods-item">
						<div class="goods-img">
							...
							<img data-original="/mineop/1/wstmall/<?php echo ($goods['goodsThums']); ?>" width="180" />
							</a>
						</div>
						<div class="goods-des">
							...
							<div class="goods-buy">
								...
								<div class="goods-right">
								    <?php if($goods['goodsStock'] > 0): ?><a href="javascript:addCart(<?php echo ($goods['goodsId']); ?>,0,'<?php echo ($goods['goodsThums']); ?>')" class="btnCart">
										<img src="/mineop/1/wstmall/Apps/Home/View/default/images/btn_addcart.png" width="85"/>
										</a>
									<?php else: ?>
