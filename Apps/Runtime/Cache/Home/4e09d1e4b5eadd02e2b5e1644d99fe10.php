...
<html lang="zh-cn">
	<head>
     	...
     	<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/shophome.css" />
		...
		<link href="/mineop/1/wstmall/Public/plugins/slide/css/slide.css" type="text/css" media="all" rel="stylesheet" />
		<style>
...
<div class="headNav">
		...
		<div>
			<?php if($shops['shopBanner'] != ''): ?><img data-original="/mineop/1/wstmall/<?php echo ($shops['shopBanner']); ?>" width="100%" height="120"/><?php endif; ?>
		</div>
		<div class="wst-shophome-nav">
			<div class="wst-shophome-nav-box">
				...
				<?php if(is_array($shopscates)): $k = 0; $__LIST__ = $shopscates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><a href="<?php echo U('Home/Shops/toShopHome/',array('shopId'=>$vo['shopId'],'ct1'=>$vo['catId']));?>"><li <?php if($ct1 == $vo['catId']): ?>class="liselected"<?php endif; ?>><?php echo ($vo["catName"]); ?></li></a><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</div>
				...
				<ul class="ck-slide-wrapper">
					<?php if(is_array($shops['shopAds'])): $i = 0; $__LIST__ = $shops['shopAds'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a target="_blank" href="<?php echo ($vo["adUrl"]); ?>">
								<img data-original="/mineop/1/wstmall/<?php echo ($vo["adImg"]); ?>" width="100%" height="350"/>
							</a>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
					...
					<div class="wst-goods-cate-box">
						...
						<div class="hotsale-goods-box" >
							<?php if(is_array($shopscates)): $k = 0; $__LIST__ = $shopscates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li data="pcate-<?php echo ($k); ?>" class="pcate-<?php echo ($k); ?> pcate" style=""><span id="pcate-<?php echo ($k); ?>-s" class="span2"></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["catName"]); ?></li>
								<?php if(is_array($vo['children'])): $k2 = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><a href="<?php echo U('Home/Shops/toShopHome/',array('shopId'=>$vo2['shopId'],'ct1'=>$vo['catId'],'ct2'=>$vo2['catId']));?>"><li class="pcate-<?php echo ($k); ?>-c ccate" ><img src="/mineop/1/wstmall/Apps/Home/View/default/images/icon_dire_more.png" width="5" height="10"/>&nbsp;<?php echo ($vo2["catName"]); ?></li></a><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
							...
							<?php if(is_array($shopsgoods)): $k = 0; $__LIST__ = $shopsgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="wst-goods-item">
								<div class="goods-img">
									<a href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$vo['goodsId']));?>">
										<img data-original="/mineop/1/wstmall/<?php echo ($vo['goodsThums']); ?>" width="180" />
									</a>
								</div>
								<div class="goods-des">
...
<!--右侧贴边导航quick_links.js控制-->
	...
	<script src="/mineop/1/wstmall/Apps/Home/View/default/js/shophome.js"></script>
	...
	<script src="/mineop/1/wstmall/Public/plugins/slide/js/slide.js"></script>
