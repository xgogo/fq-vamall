...
<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/userorder.css" />

    <div class="wst-body"> 
       
	   <div class="wst-order-userinfo-box" style="">
	   		<div class="wst-userimg-box">
	   			<img src="<?php if(empty($WST_USER['userPhoto'])): ?>/mineop/1/wstmall/Apps/Home/View/default/images/logo.png<?php else: ?>/mineop/1/wstmall/<?php echo ($WST_USER['userPhoto']); endif; ?>" height="100" width="100" />
	   		</div>
       ...
       <div class="wst-mywl">
       		<img src="/mineop/1/wstmall/Apps/Home/View/default/images/icon_top_03.png"  /><span style="color:#ffffff;">&nbsp;&nbsp;&nbsp;&nbsp;我的物流</span>
       </div>
       				...
       				<?php if(is_array($orderList['root'])): $key1 = 0; $__LIST__ = $orderList['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($key1 % 2 );++$key1;?><tr >
       					<td width="150">
       						<?php if(is_array($order['goodslist'])): $key2 = 0; $__LIST__ = $order['goodslist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key2 % 2 );++$key2;?><a href="<?php echo U('Home/Goods/getGoodsDetails',array('goodsId'=>$goods['goodsId']));?>">
									<img src="/mineop/1/wstmall/<?php echo ($goods['goodsThums']); ?>" height="50" width="50"/>
