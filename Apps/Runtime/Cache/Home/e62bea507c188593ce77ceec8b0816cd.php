...
<link rel="stylesheet" href="/mineop/1/wstmall/Apps/Home/View/default/css/index.css" />
		...
		<div class="wst-slide" id="wst-slide">
			<ul class="wst-slide-items">
				<?php if(is_array($indexAds)): $k = 0; $__LIST__ = $indexAds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li style="z-index: 1;"><a target="_blank"
					href="<?php echo U('Home/Index/access/',array('id'=>$vo['adId'],'url'=>$vo['adURL']));?>">
						<img src="/mineop/1/wstmall/<?php echo ($vo['adFile']); ?>" height="360" width="100%" title="<?php echo ($vo['adName']); ?>" />
				</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
		...
		<?php if(is_array($catList)): $k1 = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($k1 % 2 );++$k1;?><div class="wst-floor">
			<div class="wst-fl-left wst-fl<?php echo ($k1); ?>" style="position: relative;">
				<div
					...
					<?php if(is_array($catAds[$vo1['catId']])): $kv = 0; $__LIST__ = $catAds[$vo1['catId']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($kv % 2 );++$kv;?><a href="<?php echo U('Home/Index/access/',array('id'=>$vo['adId'],'url'=>$vo['adURL']));?>" target="_blank"> 
						<img data-original="/mineop/1/wstmall/<?php echo ($vo['adFile']); ?>" height="275" width="210" title="<?php echo ($vo['adName']); ?>" />
					</a><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<div
					style="position: absolute; top: 0px; left: 0px; width: 99%; height: 40px; padding-left: 10px; color: #ffffff; line-height: 38px; font-weight: bolder; background: url(/mineop/1/wstmall/Apps/Home/View/default/images/<?php echo ($k1); ?>fhd.png) no-repeat 100% 100%;">
					<a
						...
						<?php if(is_array($vo1['jpgoods'])): $k2 = 0; $__LIST__ = $vo1['jpgoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><li class="wst-goodsbox">
							<div class="wst-goods-thumb">
								<a
									...
									<img data-original="/mineop/1/wstmall/<?php echo ($vo2['goodsThums']); ?>" width="180" />
								</a>
							</div>
							<div class="wst-goods-thumb-des">
								<div class="goodsname">
								<a class="wst-goods-name"
									href="<?php echo U('Home/Goods/getGoodsDetails/',array('goodsId'=>$vo2['goodsId']));?>"><?php echo ($k2); echo ($vo2['goodsName']); ?></a>
								</div>
								<div>
									...
									<img data-original="/mineop/1/wstmall/Apps/Home/View/default/images/btn_addcart.png" width="85" />
									</a>
									<div class='wst-clear'></div>
								</div>
							</div>
						...
						<?php if(is_array($vo2['goods'])): $k3 = 0; $__LIST__ = $vo2['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($k3 % 2 );++$k3;?><li class="wst-goodsbox">
							<div class="wst-goods-thumb">
								<a
									...
									<img data-original="/mineop/1/wstmall/<?php echo ($vo3['goodsThums']); ?>" width="180" />
								</a>
							</div>
							<div class="wst-goods-thumb-des">
								<div class="goodsname">
								...
								<div>
									...
									<a href="javascript:addCart(<?php echo ($vo3['goodsId']); ?>,0,'<?php echo ($vo3['goodsThums']); ?>')" class="wst-right btnCart" > <img
										data-original="/mineop/1/wstmall/Apps/Home/View/default/images/btn_addcart.png"
										width="85" />
									</a>
									<div class='wst-clear'></div>
								</div>
						...
						<?php if(is_array($vo1['recommendShops'])): $k2 = 0; $__LIST__ = $vo1['recommendShops'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><div style="width: 180px; margin-top: 10px;">
							<div style="width: 180px;">
								<a
									...
									<img  data-original="/mineop/1/wstmall/<?php echo ($vo2['shopImg']); ?>" height="120" width="180" />
								</a>
							</div>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
...
<!--右侧贴边导航quick_links.js控制-->
    ...
    <script src="/mineop/1/wstmall/Apps/Home/View/default/js/global.js" type="text/javascript"></script>
    <script src="/mineop/1/wstmall/Apps/Home/View/default/js/head.js" type="text/javascript"></script>
    <script src="/mineop/1/wstmall/Apps/Home/View/default/js/goods.js" type="text/javascript"></script>
</body>
